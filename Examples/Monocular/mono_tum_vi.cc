...
int main(int argc, char **argv)
{
    ...
    if(argc < 5)
    {
        cerr << endl << "Usage: ./mono_tum_vi path_to_settings path_to_saving path_to_image_folder_1 path_to_times_file_1 (path_to_image_folder_2 path_to_times_file_2 ... path_to_image_folder_N path_to_times_file_N)" << endl;
        return 1;
    }
    ...
    ORB_SLAM3::System SLAM(strPathSetting,ORB_SLAM3::System::MONOCULAR,false, 0);
